    ...
    while True:
        ...
        if cmd in ("q", "quit", "exit"):
            ...
            try:
                ...
                condition   = input(f"  Condition {colorize('(opt)', Color.DIM)}  : ").strip()
                description = input(f"  Description {colorize('(opt)', Color.DIM)}: ").strip()
                source      = input(f"  Source {colorize('(opt)', Color.DIM)}     : ").strip()
