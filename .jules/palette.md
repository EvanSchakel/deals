...
## 2024-05-11 - Add Actionable Examples to Error Messages
**Learning:** Simply telling a user their input is invalid isn't enough; providing an actionable example of the expected format (e.g., "Please enter a number, e.g., 1200 or 1200.50") drastically improves usability, especially in CLI interfaces where users can't see form validation hints.
**Action:** When creating or modifying validation errors, always include a brief, realistic example of what correct input looks like.
